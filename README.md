# Aprendizado por Projeto Integrado (API) - EQUIPE SOL

Templateblala para os projetos do curso de graduação em Gestão da Produção Industrial, ensinando na utilização do repositório digital "GitHub". 
